...
const Content = ({ children, name, title, onClose, elementRef, action }) => {
  return (
    <>
      <header
        className="bg-bg1-100 w-full flex justify-between items-center px-[5px] py-1 text-white border-white"
        onClose={onClose}
      >
...
export default MoveableDeleteModal;
